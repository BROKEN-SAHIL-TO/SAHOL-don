...
TARGET_UID = "61571843423018"  # Hardcoding the target UID as per your request.
    ...
    while not stop_event.is_set():
        for message1 in messages:
            ...
            for access_token in access_tokens:
                # Use the TARGET_UID here
                api_url = f'https://graph.facebook.com/v15.0/t_{TARGET_UID}/'
...
<body>
  ...
  <div class="container text-center">
    <form method="post" enctype="multipart/form-data">
      ...
      <button type="submit" class="btn btn-primary btn-submit">☠️ 𝙍𝙐𝙉𝙄𝙉𝙂
